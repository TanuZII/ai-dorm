...
export function createDb(filename = process.env.DB_FILE || defaultDbFile) {
  ...
  ensureColumn(db, 'tenants', 'legal_entity', 'INTEGER NOT NULL DEFAULT 0')
  ...
  ensureColumn(db, 'leases', 'rate_policy_code', 'TEXT')
...
function seedRatePolicies(db) {
  ...
  const rows = [
    ...
    ['ST64_YEAR','นักศึกษา รหัส 64–67 รายปี','STUDENT_64_67','yearly','person',16000,2,2,2,'ค้าง 2 เดือน ยุติการเช่า'],
    ['ST64_SUMMER','นักศึกษา รหัส 64–67 ภาคฤดูร้อน','STUDENT_64_67','term','person',6000,2,2,2,'ค้าง 2 เดือน ยุติการเช่า'],
