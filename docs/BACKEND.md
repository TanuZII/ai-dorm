...
- Tenant Portal แยกหลัง Login สำหรับดูหนี้ ส่งหลักฐาน ดูสัญญา แจ้งซ่อม และรับข่าวสารเฉพาะรายการของตนเอง/ห้องของตนเอง
...
- ศูนย์รายงานลูกหนี้ การรับชำระ เงินประกัน และการนำส่งรายได้ พร้อมตัวกรอง การเรียงข้อมูล และ Export Excel จริง
- กระดานข่าวถึงผู้เช่าทุกห้องหรือเฉพาะห้อง พร้อมเปิด/ปิดคอมเมนต์
...
| GET | `/api/reports/catalog` | รายการรายงานตามข้อ 4.8–4.10 |
| GET | `/api/reports/general` | เรียกข้อมูลรายงานด้วย `type`, `from`, `to`, `period` |
